...
public final class Constants {
    ...
    * */
    ...
    public static final String I_SERVER_START_PORT = "Proxy cache server configured on port [%]";
    public static final String I_SERVER_READY = "Proxy ready for connections ...";
    // Distant web server messages
    public static final String I_WEB_SERVER_CON = "Connecting to % on port 80 ...";
    ...
    public static final String I_CACHE_CREATE_DIR = "Creating directory % ...";
    public static final String I_CACHE_DIR_EXISTS = "Directory % already exist.";
    ...
    public static final String I_CACHE_SAVE_REQ = "Save request to directory %";
    public static final String I_CACHE_SAVE_RES = "Save response to directory %";

    // Messages for errors (E_)
    // Proxy server messages
    public static final String E_WRONG_ARG_NMB = "Proxy takes exactly 1 argument (% given). Use: Proxy <server_port>";
